#!/bin/bash
#SBATCH --job-name=bright_frozen_mlp
#SBATCH --output=/n03data/huertas/euclid/sfh_clip/edfn_vislt22p0_150000/train_bright_mlp_%j.out
#SBATCH --error=/n03data/huertas/euclid/sfh_clip/edfn_vislt22p0_150000/train_bright_mlp_%j.err
...
# Usage:
#   sbatch euclid/slurm_train_zoobot_clip_bright_frozen_mlp.sh \
...
OUTPUT_DIR=${4:-${BASE_DIR}/training_bright_frozen_mlp}
RESUME_FROM=${5:-}
...
python -u -m euclid.train_zoobot_clip \
    ...
    --run-name euclid_bright_frozen_mlp_150k \
