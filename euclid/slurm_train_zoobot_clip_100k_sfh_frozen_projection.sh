#!/bin/bash
#SBATCH --job-name=euclid_sfh_fixed_clip
#SBATCH --output=/n03data/huertas/euclid/sfh_clip/edfn_100k/train_sfh_fixed_clip_%j.out
#SBATCH --error=/n03data/huertas/euclid/sfh_clip/edfn_100k/train_sfh_fixed_clip_%j.err
...
# Usage:
#   sbatch euclid/slurm_train_zoobot_clip_100k_sfh_frozen_projection.sh \
...
OUTPUT_DIR=${4:-${BASE_DIR}/training_sfh_frozen_linear_projection}
RESUME_FROM=${5:-}
...
python -u -m euclid.train_zoobot_clip \
    ...
    --run-name euclid_vis_sfh_frozen_linear_projection_100k \
