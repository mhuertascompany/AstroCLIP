#!/bin/bash
#SBATCH --job-name=euclid_zoobot_stamps
#SBATCH --output=/n03data/huertas/euclid/sfh_clip/edfn_100k/zoobot_stamps_%j.out
#SBATCH --error=/n03data/huertas/euclid/sfh_clip/edfn_100k/zoobot_stamps_%j.err
#SBATCH --nodes=1
...
#       [cutout_root] [catalog.fits] [output_directory]
