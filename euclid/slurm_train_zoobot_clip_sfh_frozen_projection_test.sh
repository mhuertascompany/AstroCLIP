#!/bin/bash
#SBATCH --job-name=sfh_fixed_clip_test
#SBATCH --output=/n03data/huertas/euclid/sfh_clip/edfn_100k/sfh_fixed_clip_test_%j.out
#SBATCH --error=/n03data/huertas/euclid/sfh_clip/edfn_100k/sfh_fixed_clip_test_%j.err
...
AUTOENCODER_CKPT=$1
OUTPUT_DIR=${BASE_DIR}/training_test_sfh_frozen_linear_projection
...
python -u -m euclid.train_zoobot_clip \
    ...
    --run-name euclid_vis_sfh_frozen_linear_projection_test \
