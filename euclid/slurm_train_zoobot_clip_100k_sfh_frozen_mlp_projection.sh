#!/bin/bash
#SBATCH --job-name=euclid_sfh_fixed_mlp
#SBATCH --output=/n03data/huertas/euclid/sfh_clip/edfn_100k/train_sfh_fixed_mlp_%j.out
#SBATCH --error=/n03data/huertas/euclid/sfh_clip/edfn_100k/train_sfh_fixed_mlp_%j.err
...
OUTPUT_DIR=${4:-${BASE_DIR}/training_sfh_frozen_residual_mlp_projection}
RESUME_FROM=${5:-}
...
python -u -m euclid.train_zoobot_clip \
    ...
    --run-name euclid_vis_sfh_frozen_residual_mlp_projection_100k \
