#!/bin/bash
#SBATCH --job-name=cweb_umap_zoobot_v5
#SBATCH --output=/n03data/huertas/COSMOS-Web/cosmosweb_clip/umap_zoobot_v5.out
#SBATCH --error=/n03data/huertas/COSMOS-Web/cosmosweb_clip/umap_zoobot_v5.err
#SBATCH --nodes=1
...
python -m cosmosweb.umap_embeddings_zoobot_multifilter \
    ...
    --z_low            1.0 \
    --z_high           3.0 \
    --output           ${OUTPUT_DIR}/umap_plots_zoobot_v5.pdf \
    --npz_output       ${OUTPUT_DIR}/cosmosweb_umap_zoobot_v5.npz \
    --batch_size       128 \
    --n_neighbors      15 \
    --min_dist         0.1 \
    --clustering       kmeans \
